...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script src="../js/myjavamonitor.js"></script>
...
<body>
    ...
    <table border="0" align="center">
    	<tr>
        	<td width="600"><input type="text" style="width:300px" placeholder="Busca un Equipo por: Id o Status" id="bs-prod"/></td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Monitores</b></h4>
            </div>
            <form id="formulario" class="formulario" onsubmit="return agregaRegistro();">
            <div class="modal-body">
				<table border="0" width="100%">
               		 <tr>
                        <td colspan="2"><input type="text" required="required" readonly="readonly" id="id-moni" name="id-moni" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    </tr>
                     <tr>
