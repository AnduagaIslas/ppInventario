...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script src="../js/myjavapro.js"></script>
...
<body>
	<h1 align="center">Tipo de Procesadores</h1>
	<section>
    ...
    <div class="registros" id="agrega-registros">
        ...
        <?php
            ...
            $registro = mysql_query("SELECT * FROM cattipoprocesadores"); 
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
               		 <tr>
                        <td colspan="2"><input type="text" required="required" readonly="readonly" id="id-tipopro" name="id-tipopro" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    </tr>
                     <tr>
