...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Tipo CPU</title>
	<link href="../css/estilo.css" rel="stylesheet">
	<script src="../js/jquery.js"></script>
      <script src="../js/myjavatipocpu.js"></script>
...
<body>
	<h1 align="center">Tipos de CPU</h1>
	<section>
    <table border="0" align="center">
    	<tr>
        	<td width="600"><input type="text" style="width:300px" placeholder="Busca un Status por: Id o Tipo" id="bs-prod"/></td>
    ...
    <div class="registros" id="agrega-registros">
        ...
        <?php
            ...
            $registro = mysql_query("SELECT * FROM cattipocpu"); 
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>CPU</b></h4>
            </div>
            <form id="formulario" class="formulario" onsubmit="return agregaRegistro();">
            <div class="modal-body">
				<table border="0" width="100%">
               		 <tr>
                        <td colspan="2"><input type="text" required="required" readonly="readonly" id="id-tipocpu" name="id-tipocpu" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    </tr>
                     <tr>
