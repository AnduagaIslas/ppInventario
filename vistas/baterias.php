...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script src="../js/myjavabaterias.js"></script>
...
<body>
	<h1 align="center">Baterias HH</h1>
	<section>
    <table border="0" align="center">
    	<tr>
        	<td width="600"><input type="text" style="width:300px" placeholder="Busca una Bateria por: Id o Status" id="bs-prod"/></td>
    ...
    <div class="registros" id="agrega-registros">
        ...
        <?php
            ...
            $registro = mysql_query("SELECT * FROM bateriashh"); 
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
               		 <tr>
                        <td colspan="2"><input type="text" required="required" readonly="readonly" id="id-bat" name="id-bat" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="date"  required="date" name="fechafab" id="fechafab"/></td>
                    </tr>
                    <tr>
                    	<td>Observaciones: </td>
