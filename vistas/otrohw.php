...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script src="../js/myjavahw.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Otro HW</b></h4>
            </div>
            <form id="formulario" class="formulario" onsubmit="return agregaRegistro();">
            <div class="modal-body">
				<table border="0" width="100%">
               		 <tr>
                        <td colspan="2"><input type="text" required="required" readonly="readonly" id="id-otro" name="id-otro" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                        <td>Nombre de Red:</td>
                        <td><input type="text" required="required" name="nombrer" id="nombrer"/></td>
                    </tr>
                    <tr>
