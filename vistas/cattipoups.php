...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Tipo UPS</title>
	<link href="../css/estilo.css" rel="stylesheet">
	<script src="../js/jquery.js"></script>
      <script src="../js/myjavatipoups.js"></script>
...
<body>
	<h1 align="center">Tipos de UPS</h1>
	<section>
    ...
    <div class="registros" id="agrega-registros">
        ...
        <?php
            ...
            $registro = mysql_query("SELECT * FROM cattipoups"); 
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
               		 <tr>
                        <td colspan="2"><input type="text" required="required" readonly="readonly" id="id-tipoups" name="id-tipoups" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    </tr>
                     <tr>
