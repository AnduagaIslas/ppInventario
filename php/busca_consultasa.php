...
$registro = mysql_query("Select IdOtroHw,NombreEquipo,NumeroSerie,IdUsuario,IdEspecificaciones,Marca,Modelo,NombreRed,FechaAdquisicion,Status,FechaAsignacion,
                                     ...
                                     from
                                        ...
                                        where NombreEquipo='Switch' or NombreEquipo='Access Point' or NombreEquipo='Switch_No_Red' and where IdOtroHw LIKE '%$dato%' OR NombreEquipo LIKE '%$dato%' ORDER BY IdOtroHw ASC");
